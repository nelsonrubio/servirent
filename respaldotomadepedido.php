          ...
          <form role="form" method="POST" id="registroPedido">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control cilindro" name="cilindro" style="width: 100%;">
                    <?php
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control bodega" name="chofer" style="width: 100%;">
                    <?php
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input redcompra" type="checkbox" name="redcompra" id="redcompra">
                      <label class="form-check-label">RedCompra</label>
                    </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input efectivo" type="checkbox" name="efectivo" id="efectivo">
              ...
              <div class="col-md-3">
                <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input transferencia" type="checkbox" name="transferencia" id="transferencia">
                      <label class="form-check-label">Transferecia</label>
                    </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input otros" type="checkbox" name="otros" id="otros">
              ...
              <div class="col-md-12">
                  ...
                  <label for="">Direccion</label>
                    <textarea class="form-control direccion" name="observacion" rows="3" placeholder="Direccion"></textarea>
                  </div>
                </div>
            </div>
