...
include('conexion/conexion.php');
        ...
        mysqli_query($con, "insert into obras(nombreObra,direccion,telefono,responsable,telefonoResponsable, correo, fechaInicio, FechaFinalizacion) 
                                values ('$nombreObra','$direccion', '$telefono', '$responsable', '$telefonoResponsable', '$correo', '$fechaInicio', '$fechaFin')") or 
