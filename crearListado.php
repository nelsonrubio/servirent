    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
          <form role="form" method="POST" action="procesarLista.php">
            <label for="">Datos de la lista de precios</label>
        
            <div class="row">
              <div class="col-md-6">
                <label for="">Descripcion de la lista</label>
                <div class="form-group">
                    <input type="text" name="nombre" class="form-control descripcion" id="descripcion" value="" >
                </div>
              </div>
              <div class="col-md-6">
                <label for="">Precio</label>
                <div class="form-group">
                    <input type="text" name="precio" class="form-control razon" id="razon" value="" >
                </div>
              </div>
              <div class="alert alert-success col-md-12" id="alert" style="display: none;">&nbsp;</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit " class="btn btn-primary btn-block ">Registrar lista</button> 
                    </div>
                </div>
              </div>
