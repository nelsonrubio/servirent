          ...
          <form role="form" method="POST" action="actualizarPEdido.php" id="registroPedido">
            ...
            <div class="row">
              ...
              <label for="">Estatus del pedido</label>
                <div class="form-group">
                  <select class="form-control estatus" name="estatus" id="estatus" style="width: 100%;">
                    <?php
                     while ($reg2 = mysqli_fetch_array($estatus)) {
                      echo '<option value='.$reg2['idEstatus'].'>' . $reg2['nombreEstatus'] . '</option>';
                    }
                    ?>
                  </select>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <input type="hidden" name="devolucion" class="form-control devolucion" id="devolucion" placeholder="Cilindros devueltos" value = "0">
                  <input type="hidden" name="idPedido" class="form-control devolucion" id="idPedido" placeholder="Cilindros devueltos" value = "<?php echo $_GET['id']; ?>">
                </div>
              </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <button type="submit " class="btn btn-primary btn-block " id="updatePedido">Actualizar pedido</button>
                </div>
            </div>
          </form>
