...
<head>
  ...
  <title>Gestionar estatus bodega</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gestionar bodega</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Gestionar bodega</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <form role="form" method="POST" id="registro">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <textarea type="text" name="usuario" class="form-control usuario" placeholder="descripcion "></textarea>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="password" class="form-control password" value="<?php echo $_GET['id']?>"  placeholder="contraseña">
                    <input type="text" name="password" class="form-control password" value="<?php echo $_GET['cantidad']?>"  placeholder="contraseña">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
