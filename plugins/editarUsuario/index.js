$( document ).ready(function() {
    console.log("edicion de usuarios");
    $('#registro').validate({
        rules: {
            usuario: {
                required: true
        ...
        submitHandler: function(form) {
            $.ajax({
                ...
                data: "name=" + escape($('.usuario').val()) + "&email=" + escape($('.email').val()) + "&password=" + escape($('.password').val()) + "&tipo=" + escape($('.tipo').val()) + "&usuario=" + escape($('.id').val()),
