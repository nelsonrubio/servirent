...
$pagos = mysqli_query($con, "select * from pagopedido where idPedido = $idPedido ") or
die("Problemas en el select:" . mysqli_error($con));
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Detalle de cilindros</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Detalle de cilindros</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="alert alert-success" id="alert" style="display: none;">&nbsp;</div>
                        ...
                        while ($reg = mysqli_fetch_array($pedidos)) {
                          $total += $reg['cantidad'] * $reg['precio'];
                            echo'<tr>';
                                ...
                                echo '<td>' . $reg['cilindro'] . 'Kg</td>';  
                                echo '<td>'.$reg['cantidad'].'</td>';
                                echo '<td>'.$reg['cantidad'] * $reg['precio'].'</td>';
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        while ($reg = mysqli_fetch_array($pagos)) {
                            echo'<tr>';
                                echo '<td>' . $reg['monto'] . '</td>';
                                echo '<td>' . $reg['metodo'] . '</td>';  
                                ?>
                            </tr>
                            <?php
                        }
                ...
                <strong>Total es : $ <?php echo $total?></strong>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
