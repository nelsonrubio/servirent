...
$pedidos = mysqli_query($con, "select * from pedidos where  idChofer = $userId and tipoVenta = 2 ORDER by idPedido DESC") or
                        ...
                        if($estatus1 == 6){
                            echo'<tr style = "background-color: #B6FD7C">';
                                ...
                                echo '<td>';
                                  ...
                                  ?>
                                    <a href="detalleVentaChofer.php?id=<?php echo $id;?> "class ="btn btn-primary" ><i class='fas fa-eye' title='Editar'></i></a>
                                    <a href="agregarMetodoPago.php?id=<?php echo $id;?> "class ="btn btn-primary" ><i class='fas fa-credit-card' title='Editar'></i></a>
                                  <?php
                                    }
                                  ?>
                                </td>
