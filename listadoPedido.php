...
$pedidos = mysqli_query($con, "select * from pedidos where tipoVenta = 1 ORDER by idPedido DESC") or
die("Problemas en el select:" . mysqli_error($con));
$pedidosChofer = mysqli_query($con, "select * from pedidos where tipoVenta = 2 ORDER by idPedido DESC") or
die("Problemas en el select:" . mysqli_error($con));
?>
<!DOCTYPE html>
<html>
            ...
            <div class="card">
              ...
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="false">Pedidos servigas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link " id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="true">Pedidos domiciliarios</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <tbody>
                    ...
                    <?php
                     ...
                     <?php
                        if($estatus1 == 6){
                            echo'<tr style = "background-color: #CEFE87">';
                                ...
                                echo '<td>';
                                   ...
                                   echo"<a href='detallePedido.php?id=$id 'class ='btn btn-primary' ><i class='fas fa-eye' title='Editar'></i></a>";
                  ...
                  <tbody>
                    ...
                    <?php
                        while ($reg = mysqli_fetch_array($pedidosChofer)) {
                          $id = $reg['idPedido'];
                          $bodega = $reg['idBodegas'];
                          $chofer = $reg['idChofer'];
                          $estatus1 = $reg['estatusPedido'];
