    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <!-- /.card-header -->
          <div class="card-body">
          <form role="form" method="POST" action="resultGasto.php">
            
            <div class="row">
              <div class="col-md-6">
              <label for="">Ingrese una fecha</label>
                <div class="form-group">
                  <input type="text" name="fecha" class="form-control fecha" id="datepicker" placeholder="Fecha">
                </div>
              </div>
              <div class="col-md-6">
              <label for="">Seleccione el gasto</label>
                <div class="form-group">
                <select class="form-control chofer" name="gasto" style="width: 100%;">
                    <?php
