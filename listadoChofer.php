...
$registros = mysqli_query($con, "select * from usuarios where tipoUsuario = 3") or
                        ...
                        while ($reg = mysqli_fetch_array($registros)) {
                          $id = $reg['idUsuario'];
                            echo'<tr>';
                                ...
                                ?>
                                <td>
                                <a href="asignarBodega.php?id=<?php echo $id;?> "class ="btn btn-primary" ><i class='fas fa-home' title='Editar'></i></a>
